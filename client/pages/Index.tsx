  ...
  const features = [
    {
      ...
      accent: "border-blue-600/20 dark:border-blue-400/20",
    },
    {
      icon: Users,
      ...
      accent: "border-green-600/20 dark:border-green-400/20",
    },
    {
      icon: BarChart3,
      ...
      accent: "border-orange-600/20 dark:border-orange-400/20",
    },
    {
      icon: Trophy,
      title: "Leaderboards",
      ...
      accent: "border-yellow-600/20 dark:border-yellow-400/20",
    },
    {
      icon: Target,
      ...
      accent: "border-purple-600/20 dark:border-purple-400/20",
    },
    {
      icon: Share2,
      ...
      bgColor: "bg-pink-600/10 dark:bg-pink-400/10",
      accent: "border-pink-600/20 dark:border-pink-400/20",
    },
  ];
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <Badge
              variant="outline"
              className="mb-6 border-blue-500/30 text-blue-600 dark:text-blue-400 font-bold px-6 py-2 bg-blue-50 dark:bg-blue-950/50"
            >
